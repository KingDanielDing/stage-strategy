"""
daily_stage_v2.py — Extended version with (2,6) and (3,6) BUY patterns.

Usage:
    python daily_stage_v2.py AAPL
    python daily_stage_v2.py NVDA 2022-01-01 2026-12-31
"""
...
def plot_trades(
    ...
    ax.set_title(f"{ticker}  —  Stage-Pattern Strategy (v2)", fontsize=14, fontweight="bold")
...
if __name__ == "__main__":
    ...
    if result is not None:
        ...
        if trades:
            ...
            chart_file = f"{ticker}_trades_v2.png"
